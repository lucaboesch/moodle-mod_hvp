...
Feature: Add mod_hvp accordion H5P activity
  In order to let students access a H5P accordion
  As a teacher
  I need to add a accordion H5P activity to a course
  ...
  Background:
    ...
    And I click on "Get" "button" in the "#h5p-accordion" "css_element"
    ...
    And I wait "2" seconds
    And I should see "Accordion successfully installed!"
  ...
  @javascript
  Scenario: Add an Accordion H5P activity to a course by uploading
    When I log in as "teacher1"
    And I add a "hvp" activity to course "Course 1" section "1"
    And I wait until "h5p-editor-iframe" iframe is interactable and switch to it
    And I follow "Upload"
    And I should see "Upload an H5P file."
    And I upload "mod/hvp/tests/fixtures/accordion.h5p" file to "Upload an H5P file" HVP filemanager
    And I click on "Use" "button" in the ".h5p-hub-upload-form" "css_element"
    And I wait until the page is ready
    And I should see "Accordion was successfully uploaded!"
